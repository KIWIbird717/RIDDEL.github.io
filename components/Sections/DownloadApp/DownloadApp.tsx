      ...
      <Grid>
        <Grid column style={{ width: !mobile ? '50%' : '100%' }}>
          ...
          <Grid
            ...
            <a className={link} href="">
              <img style={{ width: mobile ? 'calc(var(--index) * 12)' : '' }} src={'store.svg'} alt="" />
            </a>
          </Grid>
          <Grid
            centerX
            ...
            <img className='aboutimg' style={{ width: 'calc(var(--index) * 22 )' }} src={'phone.png'} alt={'phone'} />
            <div
              style={{
                width: '50%',
                position: 'absolute',
              ...
              <Text className='textAPP'>
                Riddle is the leading cycling-oriented Move to Earn app that allows you to increase your physical endurance while
                earning real cash
              </Text>
            </div>
          </Grid>
