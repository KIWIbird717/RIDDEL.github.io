...
import bike from '../../../public/collectionbike/1.png'
...
export const Collection = ({ ...props }: CollectionProps): JSX.Element => {
  ...
  return (
    <div
      ...
      <Text heading3 style={{padding: !mobile ? '0 calc(var(--index) * 5)' : '0 calc(var(--index) * 2)',marginBottom: 'calc(var(--index) * 2)',marginTop: 'calc(var(--index) * 3)'}}>
            <a className='mobilemenutext'>Menu</a>
          </Text>
      </Grid>
      <Grid className='mobilemenu'>
